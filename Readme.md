...
> Source code for linux version is on the [linux branch](https://github.com/Zynix-Scripts/Blur-AutoClicker-Linux/tree/linux).
> Old readme for main branch is [here](https://github.com/Blur009/Blur-AutoClicker/blob/ee87435ff2631c2f749b960ae1d4cbb078b7ecf8/Readme.md)
## Supports Wayland AND X11

## Why

A lot of popular auto clickers like OP Auto Clicker and Speed Auto Clicker are inaccurate at higher speeds (for example: setting 50 CPS might give you 40 or 60.) This project aims for precision: click exactly at the CPS you set, even at high speeds.
